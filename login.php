...
<html class="no-js" lang="es">
    <head>
        ...
        <title>Login | Milla 83</title>

        <link rel="canonical" href="https://milla83.com/login">
    ...
    <body id = "loginBody">
        ...
        <!-- Login Form -->
        <section class="wow fadeIn bg-light-gray" id = "loginSection">
            <div class="container">
                    ...
                    <div class="row justify-content-center"> 
                        <div class="col-12 col-lg-6 wow fadeIn">
                            <div class="padding-fifteen-all bg-white border-radius-6 lg-padding-seven-all">
                                <div class="text-extra-dark-gray alt-font text-extra-large font-weight-600 margin-30px-bottom">Iniciar sesión</div> 
                                <div>
                                    <input type="text" name="loginUser" id="loginUser" placeholder="Usuario" class="input-bg">
                                    <input type="password" name="loginPassword" id="loginPassword" placeholder="Contraseña" class="input-bg">
                                    <div class="text-right"><button id="loginSubmit" name = "loginSubmit" type="submit" class="btn btn-small border-radius-4 btn-black">Login</button></div>
                                </div>
                                <div class="margin-five-tb">
                                    <?php
                                        if(isset($_POST['loginUser']) && isset($_POST['loginPassword'])){
                                            if(userEx() != -1){
                                                $_SESSION['usr'] = $usuario;
                                                echo '<meta http-equiv="refresh" content="0; url=dashboard_admin">';
                                            }
                                            else echo $errorMsg;
                                        }
                                    ?>
