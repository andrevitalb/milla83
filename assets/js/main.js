...
$(document).ready(function () {
    ...
    $(document).on("click", '#button-subscribe-newsletter', function () {
        ...
        if (error) {
            $.ajax({
                type: "POST",
                url: "email-templates/subscribe.php",
    ...
    $(document).on("click", '#button-subscribe-newsletter2', function () {
        ...
        var errorMsgs = ["Algo salió mal, por favor vuelve a intentarlo.", "Ya estás suscrito a nuestra lista de correos."];
        if (error) {
            $.ajax({
                type: "POST",
                url: "assets/email-templates/subscribe.php",
                ...
                success: function (result) {
                    ...
                    if(result == errorMsgs[0] || result == errorMsgs[1]) $("#success-subscribe-newsletter2").addClass('errorNewsletter');
    ...
    function ValidationsubscribenewsletterForm2() {
        var error = true;
        $('#subscribenewsletterform2 input').each(function (index) {
            if (index == 0) {
                if (!(/(.+)@(.+){2,}\.(.+){2,}/.test($(this).val()))) {
