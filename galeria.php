                        ...
                        <ul class="portfolio-grid work-3col hover-option5 gutter-medium galleryPreviews">
                            ...
                            <?php
                                while($rowGallery = mysqli_fetch_array($resultGallery)){
                                    ...
                                    $gal .= "' data-src='$rowGallery[3]' data-sub-html='$altText'><a href='#'><figure><div class='portfolio-img'><img src='$rowGallery[3]' alt='$altText' loading='lazy'></div><figcaption><div class='portfolio-hover-main text-center'><div class='portfolio-hover-box align-middle'><div class='portfolio-hover-content position-relative last-paragraph-no-margin'><div class='bg-deep-pink mx-auto separator-line-horrizontal-medium-light2 position-relative'></div><span class='font-weight-600 letter-spacing-1 alt-font text-white-2 text-uppercase margin-5px-bottom d-block'>$rowGallery[1]</span><p class='text-medium-gray letter-spacing-1 text-uppercase text-extra-small'>$services</p></div></div></div></figcaption></figure></a></li>";
                                    echo $gal;
                                }
                            ?>
                        </ul>
